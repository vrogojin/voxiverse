...
const FAR_TREES_MESH_INST_MAX := 512         # per-species rung-1 MultiMesh instance allocation (P1; buffer sizing, §6)
const FAR_TREES_MESH_TOTAL_MAX := 1024       # rung-1 LIVE instance cap ACROSS species (nearest-first global fill, §6)
